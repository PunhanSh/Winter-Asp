        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Zip = table.Column<byte>(type: "tinyint", nullable: false),
                    OrderNotes = table.Column<string>(type: "ntext", nullable: true),
                    CreateAccount = table.Column<bool>(type: "bit", maxLength: 250, nullable: false),
                    DifferentAddress = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportMail = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstagramFilters", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PageFrees", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PageSocials", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentFirst = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BlogMessage = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ContentSecond = table.Column<string>(type: "nvarchar(max)", nullable: true),
